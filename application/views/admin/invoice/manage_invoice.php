...
<div class="btn-group mb-lg">
    ...
    <ul class="dropdown-menu animated zoomIn">
        <li><a href="<?= base_url() ?>admin/invoice/manage_invoice"><?= lang('all'); ?></a></li>
        <?php
...
<?php $created = can_action('13', 'created');
                            ...
                            <div class="table-responsive table-bordered   mb-lg">
                                <table class="table " id="add_new">
                                    ...
                                    if (!empty($invoice_items)) :
                                        foreach ($invoice_items as $v_item) :
                                            ...
                                            <tr>
                                                ...
                                                <td><?= display_money($v_item->total_cost) ?>
                                                    <span style="visibility: hidden"
                                                          class="linetotal"><?= ($v_item->total_cost) ?></span>
                                                </td>
                                                <td class="hidden-print">
                                    ...
                                    <tr class="hidden-print">
                                        ...
                                        <td><textarea rows="1" name="item_name[]" placeholder="Item name"
                                        ...
                                        <td><input type="text" value="<?php
                                            ...
                                            ?>" name="product_tax" placeholder="0.00" readonly="" class="form-control">
                                        </td>
