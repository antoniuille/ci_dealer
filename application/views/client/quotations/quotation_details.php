...
if (empty($currency)) {
                    ...
                    <li class="list-group-item"><span class="pull-right"><blockquote
                                class="text-muted"
                                style="font-size: inherit"><?= $quotations_info->notes ?></blockquote></span><?= lang('comments') ?>
                    </li>
    ...
    <div class="col-sm-8">
        <div class="panel panel-custom">
            <div class="panel-heading  "><i class="fa fa-user"></i> <?= lang('quotaion_form_response') ?>
                <div class="pull-right hidden-print" style="margin-left: 15px;">
                    <div class="pull-left" style="margin-left: -15px;margin-top: -3px;">
